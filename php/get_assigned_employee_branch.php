...
if($_SERVER['REQUEST_METHOD'] == 'POST' && array_key_exists('branch_id', $input)){
    ...
    INNER JOIN tbl_employee_branch ON tbl_employee_branch.employee_id = tbl_employee.employee_id 
    WHERE tbl_employee_branch.branch_id = :branch_id ORDER BY tbl_employee.last_name ASC;";
